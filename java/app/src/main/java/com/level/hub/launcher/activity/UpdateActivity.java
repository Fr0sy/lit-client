...
public class UpdateActivity extends AppCompatActivity{
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 4) {
                ...
                if (valueOf == UpdateStatus.DownloadGameData) {
                    ((TextView)findViewById(R.id.installation_text)).setText("Загрузка файлов игры...");
                    Log.d("LEVEL", "statusname = " + valueOf);
                    ...
                    ((TextView)findViewById(R.id.installation_text)).setText("Обновление игры...");
                    Log.d("LEVEL", "statusname = " + valueOf);
                    long j = msg.getData().getLong("total");
                    long j2 = msg.getData().getLong("current");
                    ((TextView) findViewById(R.id.fileName)).setText(msg.getData().getString("filename"));
            ...
            {
                Intent intent;
                Log.d("LEVEL", "UpdateService.UPDATE_GAME_DATA");
                ...
                if (msg.getData().getBoolean("status", false)) {
                    ...
                    if (mGameApk == null || !mGameApk.exists()) {
                        Log.d("LEVEL", "Error update game data");
                ...
                ((TextView)findViewById(R.id.installation_text)).setText("Загрузка...");
                ProgressBar progressBar = (ProgressBar) UpdateActivity.this.findViewById(R.id.download_progress);
    ...
    {
        Log.d("LEVEL", "request install game");
